...
<section class="blog-archive section blog">
	...
	<?php if ( $max_pages > 1) : ?>
		<div id="load-more" class="wp-block-button arrow-link filled-button pink white" data-cat="<?php echo $category_ID ?>" data-page="1" data-max-pages="<?php echo $max_pages ?>">
